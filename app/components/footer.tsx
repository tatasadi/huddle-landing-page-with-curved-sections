...
const Footer = () => {
  return (
    <footer className="w-full max-w-[90rem]">
      ...
      <div className="bg-very-dark-cyan flex flex-col px-7 pb-12 pt-20 text-white lg:flex-row lg:justify-between lg:px-[7.5rem] lg:pb-[6.44rem] lg:pt-[5rem]">
        <form className="flex flex-col items-start lg:order-2">
          ...
          <div className="flex w-full flex-col items-end gap-4 lg:flex-row lg:gap-10">
            <input
              type="email"
